            ...
            switch (choice) {
                case 1:
                    ...
                    if (count == n) {
                        ...
                        for (int i = 0; i < n; i++) {
                            ...
                            total[i] = s[i].calculateTotalMarks(assignmentOneMarks[i], assignmentTwomarks[i],
                                    projectMarks[i]);
                    ...
                    if (count == 0) {
                        ...
                        for (int i = 0; i < n; i++) {
                            System.out.printf(
                                    ...
                                    s[i].getStudentName(), s[i].getStudentID(), s[i].getAssignmentOneMarks(),
                                    s[i].getAssignmentTwoMarks(), s[i].getProjectMarks(), total[i]);
                        }
                    }
                    break;
                ...
                case 3:
                    ...
                    if (count == 0) {
                        ...
                        System.out.printf(
                                "\n The student %s with student number %s has received maximum marks which is %f",
                                st_name[max], st_ID[max], total[max]);
                        System.out.printf(
                                "\n The student %s with student number %s has received minimum marks which is %f",
                                st_name[min], st_ID[min], total[min]);
